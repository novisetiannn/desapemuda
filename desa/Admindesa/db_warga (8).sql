...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Jul 2023 pada 14.33
...
(70, 'ese', 'zseffzes', 0x636f6e746f682d62656e64612d62657262656e74756b2d6a616a61722d67656e6a616e672d33202831292e6a7067, '2023-07-25');
...
INSERT INTO `visi_misi` (`id`, `Visi`, `Misi`, `id_admin`) VALUES
(105, 'Menjadi Desa yang Unggul, Berdaya Saing, dan Berkelanjutan dalam Mewujudkan Kesejahteraan Masyarakat', 'Mewujudkan pemerintahan desa yang transparan, akuntabel, dan partisipatif.', 1),
(106, 'Menjadi Desa yang Maju, Mandiri, dan Sejahtera dalam Bingkai Keharmonisan dan Kebhinekaan.', 'Memperkuat potensi sumber daya manusia desa melalui pengembangan pendidikan dan pelatihan.', 1),
(107, '', 'Meningkatkan kesejahteraan masyarakat desa dengan mengembangkan sektor ekonomi lokal.', 1),
(112, '', 'Memperkuat kerjasama dan komunikasi antara Desa Pemuda dengan pihak terkait dan desa-desa lainnya.', 1),
(115, 'mahasiswa', 'Politala', 1);
...
--
ALTER TABLE `visi_misi`
  ADD CONSTRAINT `visi_misi_ibfk_1` FOREIGN KEY (`id_admin`) REFERENCES `users` (`id_admin`);
COMMIT;
