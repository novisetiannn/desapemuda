...
<head>
	...
	<title>Selamat Datang | Desa Pesarean</title>
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-dark p-2">
	  <div class="container-fluid">
	    <a class="navbar-brand d-flex align-items-center" href="#">
	    	<img src="assets/img/logo.PNG" width="80" height="35">
	    	&nbsp; <span> </span>
	    </a>
			...
			<div class="container header-box mt-3">
				<div class="row">
					<div class="col-md-12 text-center">
						<img src="assets/img/logo.PNG" width="200" height="50" class="img-fluid">
						<h3 class="mt-2">Website Desa Pesarean</h3>
						<p>"Menuju Desa Mandiri dan Sejahtera"</p>
						<br><center><p>Copyright by <a href='' title='' target='_blank'>Cnid Code</a></p></center>
	...
	<footer id="footer" class="mt-5 p-3 bg-dark">
		<div class="container text-center">
			<p class="text-white">&copy;&nbsp; Copyright By <a href='' title='' target='_blank'>Cnid Code</a>
			</p>
		</div>
	</footer>
